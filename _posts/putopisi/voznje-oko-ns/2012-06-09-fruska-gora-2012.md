...
{% include component/id.html id="20120225" %}
...
{% include component/youtube/img_full.html id="cAHoSyFdUwc" %}

{% include component/img/horizontal.html file_name="20120225-0.jpg" %}
...
{% include separator.html %}
{% include component/id.html id="20120304" %}
### Lekovito blato
...
{% include component/img/full.html file_name="20120304-1.jpg" %}
...
{% include separator.html %}
{% include component/id.html id="20120307" %}
### Popovica - Provalije
...
{% include component/img/full.html file_name="20120307-0.jpg" %}
...
{% include separator.html %}
{% include component/id.html id="20120317" %}
### Vila Ravne
...
{% include component/img/full.html file_name="20120317-0.jpg" %}

{% include component/img/horizontal.html file_name="20120317-1.jpg" %}
...
{% include component/img/horizontal.html file_name="20120317-2.jpg" %}
...
{% include separator.html %}
{% include component/id.html id="20120401" %}
...
{% include component/img/full.html file_name="20120401-004.jpg" %}

{% include component/img/horizontal.html file_name="20120401-000.jpg" %}
...
{% include separator.html %}
{% include component/id.html id="20120407" %}
...
{% include component/img/full.html file_name="20120407-001.jpg" %}

{% include component/img/horizontal.html file_name="20120407-003.jpg" %}
...
{% include separator.html %}
{% include component/id.html id="20120512" %}
...
{% include component/youtube/video.html id="mKCPtfReY9M" %}

Ovo je bila jedna od onih "epskih" vožnji, kada se za kratko vreme svašta vidi, obiđe i svašta interesantno izdešava.

{% include component/img/horizontal.html file_name="20120512-01.jpg" %}
...
{% include component/img/horizontal.html file_name="20120512-11.jpg" %}
...
{% include component/img/horizontal.html file_name="20120512-19.jpg" %}
...
{% include component/img/horizontal.html file_name="20120512-20.jpg" %}
...
{% include component/img/horizontal.html file_name="20120512-33.jpg" %}
...
{% include component/img/horizontal.html file_name="20120512-37.jpg" %}
...
{% include separator.html %}
{% include component/id.html id="20120609" %}
...
{% include component/img/horizontal.html file_name="20120609-medjes.jpg" %}
...
{% include separator.html %}
{% include component/id.html id="20120830" %}
...
{% include component/img/full.html file_name="20120830-01.jpg" %}
...
{% include component/img/horizontal.html file_name="20120830-21.jpg" %}
...
<ul>
  <li>{% include component/pdf.html path="/voznje-oko-ns/fruska-gora-2012/lokacije-ledinci.pdf" title="analiza lokacija oko Starih Ledinaca" %}</li>
  <li>{% include component/pdf.html path="/voznje-oko-ns/fruska-gora-2012/earthship-materijal.pdf" title="analiza materijala i troškova za izgradnju Earthship-a" %}</li>
  <li>{% include component/pdf.html path="/voznje-oko-ns/fruska-gora-2012/obnovljivi-izvori-energije.pdf" title="analiza mogućnosti korišćnja vode i energije iz obnovljivih izvora" %}</li>
</ul>