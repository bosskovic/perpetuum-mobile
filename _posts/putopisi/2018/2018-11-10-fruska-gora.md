...
{% include component/id.html id="20180303" %}
...
{% include component/youtube/img_full.html id="casy0CIi0Ic" %}

{% include component/img/horizontal.html file_name="20180303-06.jpg" %}
...
{% include component/img/horizontal.html file_name="20180303-32.jpg" %}
...
{% include separator.html %}
{% include component/id.html id="20180320" %}
...
{% include component/youtube/img_full.html id="ky3BoqEp3A0" %}

{% include component/img/horizontal.html file_name="20180320-02.jpg" %}
...
{% include component/img/horizontal.html file_name="20180320-06.jpg" %}
...
{% include separator.html %}
{% include component/id.html id="20180408" %}
...
{% include component/youtube/img_full.html id="67QYRiGR2KE" %}
...
{% include component/img/horizontal.html file_name="20180408-02.jpg" %}
...
{% include component/img/horizontal.html file_name="20180408-11.jpg" %}
...
{% include component/img/full.html file_name="20180408-09.jpg" %}

{% include component/img/horizontal.html file_name="20180408-12.jpg" %}
...
{% endcapture %}
{% include post/side_story.html story=story title="Murgin točak" %}
...
{% include separator.html %}
{% include component/id.html id="20180414" %}
...
{% include component/img/full.html file_name="20180414-11.jpg" %}

{% include component/img/horizontal.html file_name="20180414-05.jpg" %}
...
{% include component/img/horizontal.html file_name="20180414-07.jpg" %}
...
{% include component/img/horizontal.html file_name="20180414-11.jpg" %}
...
{% include component/img/full.html file_name="20180414-13.jpg" %}

{% include component/img/horizontal.html file_name="20180414-16.jpg" %}
...
{% include separator.html %}
{% include component/id.html id="20180421" %}
...
{% include component/youtube/img_full.html id="4U7kGR8nttU" %}
...
{% include separator.html %}
{% include component/id.html id="20180915" %}
### Krug oko Orlovca
...
{% include component/youtube/img_full.html id="02KVCGkdZ8s" %}
...
{% include separator.html %}
{% include component/id.html id="20180923" %}
...
{% include separator.html %}
{% include component/id.html id="20181027" %}
### Tancoš
...
{% include component/youtube/img_full.html id="V6aU4srzZ_c" %}

Stigla prava jesen, a mi šetamo prelepim grebenima oko Crvenog čota.

{% include separator.html %}
{% include component/id.html id="20181028" %}
### Stražilovo
...
{% include component/youtube/img_full.html id="7DBE14k0gH8" %}

Laganini šetnja uprkos košavi.

{% include separator.html %}
{% include component/id.html id="20181110" %}
### Venac
...
{% include component/youtube/img_full.html id="J-quwba8AVI" %}
